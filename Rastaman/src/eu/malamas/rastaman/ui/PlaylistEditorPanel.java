...
public class PlaylistEditorPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Box.Filler filler8 = new Box.Filler(new Dimension(5, 50), new Dimension(5, 50), new Dimension(5, 50));
        JPanel selectedSongPanel = new JPanel();
        Box.Filler filler13 = new Box.Filler(new Dimension(5, 10), new Dimension(5, 10), new Dimension(120, 10));
        JPanel namePanel = new JPanel();
        Box.Filler filler23 = new Box.Filler(new Dimension(5, 50), new Dimension(5, 50), new Dimension(5, 50));
        nameLabel = new JLabel();
        Box.Filler filler27 = new Box.Filler(new Dimension(5, 50), new Dimension(5, 50), new Dimension(5, 50));
        nameTextField = new JTextField();
        Box.Filler filler18 = new Box.Filler(new Dimension(0, 0), new Dimension(0, 0), new Dimension(32767, 32767));
        Box.Filler filler16 = new Box.Filler(new Dimension(5, 5), new Dimension(5, 5), new Dimension(120, 5));
        JPanel datePanel = new JPanel();
        Box.Filler filler24 = new Box.Filler(new Dimension(5, 50), new Dimension(5, 50), new Dimension(5, 50));
        dateLabel = new JLabel();
        Box.Filler filler26 = new Box.Filler(new Dimension(5, 50), new Dimension(5, 50), new Dimension(5, 50));
        dateTextField = new JTextField();
        Box.Filler filler25 = new Box.Filler(new Dimension(5, 50), new Dimension(5, 50), new Dimension(5, 50));
        ...
        Box.Filler filler20 = new Box.Filler(new Dimension(5, 5), new Dimension(5, 5), new Dimension(120, 5));
        JPanel durationPanel = new JPanel();
        Box.Filler filler28 = new Box.Filler(new Dimension(5, 50), new Dimension(5, 50), new Dimension(5, 50));
        durationLabel = new JLabel();
        Box.Filler filler29 = new Box.Filler(new Dimension(5, 50), new Dimension(5, 50), new Dimension(5, 50));
        durationTextField = new JTextField();
        Box.Filler filler30 = new Box.Filler(new Dimension(0, 0), new Dimension(0, 0), new Dimension(32767, 32767));
        Box.Filler filler31 = new Box.Filler(new Dimension(5, 10), new Dimension(5, 10), new Dimension(120, 10));
        ...
        Box.Filler filler14 = new Box.Filler(new Dimension(5, 40), new Dimension(5, 40), new Dimension(120, 40));
        downButton = new JButton();
        Box.Filler filler15 = new Box.Filler(new Dimension(0, 0), new Dimension(0, 0), new Dimension(32767, 32767));
        addButton = new JButton();
        Box.Filler filler6 = new Box.Filler(new Dimension(5, 40), new Dimension(5, 40), new Dimension(120, 40));
        removeButton = new JButton();
        Box.Filler filler7 = new Box.Filler(new Dimension(0, 0), new Dimension(0, 0), new Dimension(32767, 32767));
        JPanel availableSongPanel = new JPanel();
        Box.Filler filler19 = new Box.Filler(new Dimension(5, 10), new Dimension(5, 10), new Dimension(120, 10));
        JPanel filterPanel = new JPanel();
        filterLabel = new JLabel();
        Box.Filler filler10 = new Box.Filler(new Dimension(5, 50), new Dimension(5, 50), new Dimension(5, 50));
        filterTextField = new JTextField();
        Box.Filler filler12 = new Box.Filler(new Dimension(10, 50), new Dimension(10, 50), new Dimension(10, 50));
        ...
        Box.Filler filler21 = new Box.Filler(new Dimension(5, 10), new Dimension(5, 10), new Dimension(120, 10));
        JScrollPane scrollPane2 = new JScrollPane();
        availableSongTable = new JTable();
        Box.Filler filler22 = new Box.Filler(new Dimension(5, 5), new Dimension(5, 5), new Dimension(120, 5));
        Box.Filler filler9 = new Box.Filler(new Dimension(5, 50), new Dimension(5, 50), new Dimension(5, 50));
