 ...
 */
public class LabelTablePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(ELProperty.create("${telephone}"));
        columnBinding.setColumnName("Τηλέφωνο");
        columnBinding.setColumnClass(String.class);
        bindingGroup.addBinding(jTableBinding);
        jTableBinding.bind();
        scrollPane1.setViewportView(labelTable);
        ...
        Binding binding = Bindings.createAutoBinding(AutoBinding.UpdateStrategy.READ_WRITE, labelTable, ELProperty.create("${selectedElement!=null}"), editButton, BeanProperty.create("enabled"));
        ...
        binding = Bindings.createAutoBinding(AutoBinding.UpdateStrategy.READ_WRITE, labelTable, ELProperty.create("${selectedElement!=null}"), deleteButton, BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
    ...
    //κλίκ στο πλήκτρο Εισαγωγή Εταιρίας
    ...
    private void editButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        //¨Ανοιγμα της φόρμας επεξεργασίας Εταιρίας με
        // παράμετρο την επιλεγμένη από τον πίνακα Εταιριών
        // Εταιρία
    ...
    private void initFurther() {
        ...
        TableColumnModel tcm = labelTable.getColumnModel();
    ...
    // Μέθοδος deleteLabel()
    // Καλείται όταν πατηθεί το πλήκτρο Διαγραφή Εταιρίας και αφου κάνει τους 
    // απαραίτητους ελέγχους διαγράφει την επιλεγμένη Εταιρία
        ...
        if (selectedIndex != -1) {
            ...
            if (selectedLabel.getAlbumList().isEmpty()) { // εαν δεν συμμετέχει σε αλμπουμ
                    ...
                    int n = JOptionPane.showOptionDialog(this,
                            "Να διαγραφεί η εταιρία: " + selectedLabel.getName() + ";",
